    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="w-full">
        ...
        <TabsContent value="products" className="space-y-6">
          ...
          <Card className="border-2 border-orange-300 shadow-lg bg-gradient-to-r from-orange-50 to-orange-100">
            <CardHeader className="bg-transparent border-b border-orange-200">
              <CardTitle className="flex items-center gap-2">
