...
export const Reports = () => {
  ...
  // 1. Filter Pengeluaran Sesuai Tanggal Laporan
  ...
  // 2. Hitung Total Biaya Operasional (REAL DARI DATABASE)
  const operatingExpenses = filteredExpenses.reduce((sum, exp) => sum + Number(exp.amount), 0);
  
  // Hapus const OPERATING_EXPENSE_PERCENTAGE = 0.15;
  // Pastikan netProfit tetep pake operatingExpenses yang baru ini
  const netProfit = grossProfit - operatingExpenses;
  
  // Tambahan rasio buat di grafik (opsional)
